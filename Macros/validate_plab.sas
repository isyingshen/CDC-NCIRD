/*************************************************************************************************/
/* Description: This macro extracts Stage2 and Stage3 Pertussis Lab variables from               */
   	...
   	data mapping_validation;
			...
			%do i=1 %to &total;
   			if (&&stg3netss&i = '#M') then
      			...
      			&&stg2netss&i.._results = 'OK';
				else if (&&stg2netss&i = 'S' and &&stg3netss&i = '26183002') then
      			o&&stg2netss&i.._results = 'OK';
