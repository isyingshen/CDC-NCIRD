/*************************************************************************************************/
/* Description: This macro extracts Stage2 and Stage3 Import variables from  				          */
...
data mapping_validation;
   ...
   %do i=1 %to &total;	
      ...
      else if (&&stg2netss&i = 1 and &&stg3netss&i = 'PHC244') then
         results_&&stg2netss&i.. = 'OK';
      else if (&&stg2netss&i = 2 and &&stg3netss&i = 'C1512888') then
         results_&&stg2netss&i.. = 'OK';
      else if (&&stg2netss&i = 3 and &&stg3netss&i = 'PHC246') then
         results_&&stg2netss&i.. = 'OK';
