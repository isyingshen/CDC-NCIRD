/*************************************************************************************************/
/* Description: This macro extracts Stage2 and Stage3 variables value which are 9,99 			    */
/*              from master variable list and validate the result for 10180, 10140, 10200, 10370 */
/*                                                                                               */
/* Created by:  Hannah Fast   10/08/2019                                                         */
/* Modified by: Anu Bhatta    11/13/2019  -Standardized the code.                                */
/*************************************************************************************************/

%macro validate_nineone;
   ...
   %do;
      ...
      data mapping_validation;
         ...
         %do i=1 %to &total;
            ...
            else if (&&stg2netss&i  = '9' and &&stg3netss&i = '99') then
