/*************************************************************************************************/
/* Description: This macro extracts Stage2 and Stage3 Hibvac variables from                      */
      ...
      data mapping_validation;
         ...
         %do i=1 %to &total;	
            if (&&stg3netss&i = '#M') then
               ...
               results_&&stg2netss&i.. = 'OK';
            else if (&&stg2netss&i = '3' and &&stg3netss&i = 'UNK') then
               results_&&stg2netss&i.. = 'OK';
