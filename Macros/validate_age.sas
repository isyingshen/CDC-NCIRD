/*************************************************************************************************/
/* Description: This macro extracts Stage2 and Stage3 Age variables from master variable list    */
...
data mapping_validation;
   ...
   set mapping_validation;
      %do i=1 %to &total;
         if (&&stg2netss&i = . and &&stg3netss&i = '') then
         ...
         else if (&&stg2netss&i = 999 and &&stg3netss&i = '9999') then
            results_&&stg2netss&i.. = 'OK';
         else
