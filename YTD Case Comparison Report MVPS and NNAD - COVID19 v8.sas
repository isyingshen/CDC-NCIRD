/**********************************************************************************/
 /* PROGRAM NAME: YTD Message Review MVPS - COVID19                                */
 /* VERSION: 8                                                                     */
 /* CREATED: 2021/12/3                                                             */
 /*                                                                                */
 /* BY:  Ying Shen                                                                 */
 ...
 /*          Added a snippet to export a csv                                       */
 ...
 /* Modified by: Ying Shen from v7 to v8                                           */
 /* Changes: Rename the program name from "YTD Message Review MVPS and NNAD" to   */
 /*              "YTD Case Comparison Report" */ 
 /*                                                                                */ 
 /**********************************************************************************/


/*Update the following info*/
%let juris=VA; *jurisdiction 2 (or 3) letter abbreviation to match folder naming convention;
%let juris_code='51'; *jurisdiction code;
...
%let ytd_dir =\\cdc.gov\project\NIP_Project_Store1\Surveillance\jheri_godfrey\YTD\VA;
...
%let lnlist=2022Covid cases.xlsx; *file name of line list from jurisdiction. Include the extension (e.g., .xlsx);
%let lnlisttab=sheet1; *tab name of the line list excel;
%let IDcolumn=inv_local_id; * the local record ID column name in the LINE LIST;
...
select *
from mvps_data_juri
where condition_specific_msg_guide in ('COVID19_MMG_V1.0','COVID19_MMG_V1.1');
quit;
