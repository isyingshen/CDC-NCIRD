...
/*Check NCIRD Created Test Messages*/
...
libname mvps OLEDB provider="sqlncli11"
     properties = ( "data source"="DSTV-INFC-1601\QSRV1" "Integrated Security"="SSPI"
           "Initial Catalog"="MVPS_UAT" ) schema=hl7 access=readonly;
