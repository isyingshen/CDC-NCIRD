/*****************************************************************************/
/*PROGRAM NAME:  ALL_NCIRD_LOOK_NNAD wk5221                                  */
/*VERSION: 1.0                                                               */
/*CREATED: 2021/8/6                                                          */
/*                                                                           */
...
/* Modified by: Ying Shen                                                    */
/* Changes: Convertd NNAD Variable to NETSS Var                              */
/*                                                                           */
/* Date Modified: 2022/1/13                                                  */
/* Modified by: Ying Shen                                                    */
/* Changes: Remove "=" in mmwr_week and convert mmwr_week from char to num   */
/*                                                                           */
/*****************************************************************************/
...
libname WK52 "\\cdc\csp_project\NCIRD_MB00\SWR1\NNAD\WK5221" access=readonly ;
...
from wk52.week5221_nnad_noncovid
where mmwr_year = "&year"
and condition not in ("10065");
quit;
