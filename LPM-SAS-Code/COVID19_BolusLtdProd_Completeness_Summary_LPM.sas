...
%let ISfilename = OR COVID-19 Implementation Spreadsheet NCIRD Review OR_Appended_5.19.22.xlsx; /* Implementation Spreadsheet document name */                                                                                                                                                                                                                                                                  

libname intrans XLSX "&projdir\source\inputs\OR Trans_IDs_4.5.23.xlsx"; /* list of trans_id */
...
/* read in user specified trans_ids */
proc sql noprint;
...
options nobyline;
ods excel file="&projdir\Outputs\&stabv. COVID-19 Completeness Summary LPM &date..xlsx" options(start_at="2, 2"  sheet_name="Completion" embedded_titles='YES');
