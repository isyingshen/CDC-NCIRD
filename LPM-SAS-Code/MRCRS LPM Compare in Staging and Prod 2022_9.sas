****************************************************************************************
Algorithm to compare MRCRS Limited Production Cases in NNAD Staging and NNAD Production

Developed by: Ying Shen
Originally written: 9/22/2022
...
****************************************************************************************;
/* Condition name   :   Measles   Rubella    CRS    */
/* Condition code:      10140     10200      10370  */
...
/*Rubella test record: 460649, 465317 statem=16*/
/*460649 16 */
/*465317 16 */

/*Update the list of local_record_id*/
%let locallist = '460649','465317';
